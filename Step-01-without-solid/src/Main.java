        ...
        do{
            ...
            switch (userAnswer){
                ...
                case 3:
                    ...
                    System.out.print("Enter source phone or id : ");
                    source = scanner.next();
                    telegramMessage.setSourceTelegramIdOrPhone(source);
                    System.out.print("Enter target phone or id : ");
                    target = scanner.next();
                    telegramMessage.setTargetTelegramIdOrPhone(target);
                    System.out.println("Write Your Message : ");
                    content = scanner.next(".*$");
